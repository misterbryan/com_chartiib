...
/**
 * Postes list controller class.
 */
class ChartiibControllerPostes extends JControllerAdmin
{
	/**
	 * Proxy for getModel.
	 * @since	1.6
	 */
	public function getModel($name = 'poste', $prefix = 'ChartiibModel', $config = array())
	{
